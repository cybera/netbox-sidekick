    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tenancy.tenant')),
                ('accounting_classes', models.ManyToManyField(to='netbox_sidekick.AccountingClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accounting_profile', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='netbox_sidekick.accountingprofile')),
            ],
            options={
