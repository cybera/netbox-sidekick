# Generated by Django 3.0.6 on 2020-05-22 03:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_contact_first_name', models.CharField(blank=True, default='', max_length=255)),
                ('billing_contact_last_name', models.CharField(blank=True, default='', max_length=255)),
                ('billing_contact_title', models.CharField(blank=True, default='', max_length=255)),
                ('billing_contact_phone_number', models.CharField(blank=True, default='', max_length=255)),
                ('billing_contact_email_address', models.EmailField(blank=True, default='', max_length=254)),
                ...
                ('technical_contact_first_name', models.CharField(blank=True, default='', max_length=255)),
                ('technical_contact_last_name', models.CharField(blank=True, default='', max_length=255)),
                ('technical_contact_title', models.CharField(blank=True, default='', max_length=255)),
                ('technical_contact_phone_number', models.CharField(blank=True, default='', max_length=255)),
                ('technical_contact_email_address', models.EmailField(blank=True, default='', max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tenancy.Tenant')),
