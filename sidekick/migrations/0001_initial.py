# Generated by Django 3.1.3 on 2021-06-27 19:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tenancy.tenant')),
                ('accounting_classes', models.ManyToManyField(to='sidekick.AccountingClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accounting_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sidekick.accountingclass')),
            ],
            options={
