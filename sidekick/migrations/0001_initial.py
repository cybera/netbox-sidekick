# Generated by Django 4.0.4 on 2025-08-06 18:47
...
class Migration(migrations.Migration):
    ...
    replaces = [('sidekick', '0001_initial'), ('sidekick', '0002_remove_networkservicel3_ipv4_prefixes'), ('sidekick', '0003_remove_networkservicel3_ipv6_prefixes')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='extras.TaggedItem', to='extras.Tag', verbose_name='Tags')),
                ('active', models.BooleanField(default=True)),
                ('ip_prefixes', models.ManyToManyField(blank=True, to='ipam.prefix')),
            ],
            options={
