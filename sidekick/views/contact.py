...
from sidekick.filters import ContactTypeFilterSet, ContactFilterSet
from sidekick.models import ContactType, Contact
from sidekick.tables import ContactTypeTable, ContactTable
...
class ContactTypeIndexView(PermissionRequiredMixin, FilterView, SingleTableView):
    permission_required = 'sidekick.view_contacttype'
    model = ContactType
    table_class = ContactTypeTable
    filterset_class = ContactTypeFilterSet
    template_name = 'sidekick/contact/contacttype_index.html'
...
class ContactTypeDetailView(PermissionRequiredMixin, DetailView):
    permission_required = 'sidekick.view_contacttype'
    model = ContactType
    template_name = 'sidekick/contact/contacttype.html'
...
class ContactIndexView(PermissionRequiredMixin, FilterView, SingleTableView):
    permission_required = 'sidekick.view_contact'
    model = Contact
    table_class = ContactTable
    filterset_class = ContactFilterSet
    template_name = 'sidekick/contact/contact_index.html'
...
class ContactDetailView(PermissionRequiredMixin, DetailView):
    permission_required = 'sidekick.view_contact'
    model = Contact
    template_name = 'sidekick/contact/contact.html'
